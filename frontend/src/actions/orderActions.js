...
export const createOrder = (order) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post(
      "https://proshop-69.herokuapp.com/api/orders",
      order,
      config
    );
...
export const getOrderDetails = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(
      `https://proshop-69.herokuapp.com/api/orders/${id}`,
      config
    );
  ...
  (orderId, paymentResult) => async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.put(
        `https://proshop-69.herokuapp.com/api/orders/${orderId}/pay`,
        paymentResult,
        config
      );
...
export const listMyOrders = () => async (dispatch, getState) => {
  try {
    ...
    //post the request with route, and config
    const { data } = await axios.get(
      `https://proshop-69.herokuapp.com/api/orders/myorders`,
      config
    );
...
export const shipOrder = (orderId) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `https://proshop-69.herokuapp.com/api/orders/${orderId}/ship`,
      {},
      config
    );
